...
public final class HDPhotoProfileTableCell: UITableViewCell {

    public static let identifier = String(describing: HDPhotoProfileTableCell.self)
    ...
    public init() {
        super.init(style: .default, reuseIdentifier: HDPhotoProfileTableCell.identifier)
        self.subviewDidAdd()
...
extension HDPhotoProfileTableCell {
